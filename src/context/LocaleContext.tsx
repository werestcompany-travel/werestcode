...
const T: Record<Lang, Strings> = {
  ...
  EN: {
    ...
    /* service tabs */
    'svc.transfer':    'Private Transfers',
    'svc.tours':       'Tours & Experiences',
    ...
    'svc.charter':      'Charter Rental',
    /* SEO route tabs */
    'seo.tab.popular':   'Popular transfers',
    'seo.tab.airport':   'Airport transfers',
    'seo.tab.city':      'City to city',
    'seo.tab.beach':     'Beach destinations',
    'seo.tab.northern':  'Northern Thailand',
    /* home sections */
    'home.newUser':      'New user exclusive',
    'home.whereNext':    'Where to next?',
    'home.vehicleOpts':  'Vehicle Options',
    'home.upTo':         'Up to',
    'home.passengers':   'passengers',
    /* dynamic tour sections */
    'tours.thingsToDo':      'Things to do in',
    'tours.handpicked':      'Handpicked experiences — book instantly',
    'tours.seeAll':          'See all',
    'tours.availableNow':    'Available now',
    'tours.reviews':         'Reviews',
    'tours.comingSoon':      'Coming soon to',
    'tours.comingSoonDesc1': "We're curating the best experiences in",
    'tours.comingSoonDesc2': 'In the meantime, explore our Bangkok tours.',
    'tours.browseAll':       'Browse all experiences',
    /* navbar mobile strings */
    ...
    'nav.travelOptions':     'Travel options',
    'nav.more':              'More',
    'nav.dealsRewards':      'Deals & Rewards',
    ...
    /* attractions page */
    'attr.hero.title':       'Discover the best theme parks, museums and more must-sees',
    'attr.hero.sub':         'Book skip-the-line tickets, tours and experiences across Thailand.',
    'attr.searchPlaceholder':'Search attractions, destinations…',
    'attr.breadcrumb':       'Attractions Tickets',
    'attr.seeAll':           'See all',
    'attr.promos':           'Promo codes',
    'attr.promos.viewAll':   'View all',
    'attr.popularDests':     'Popular destinations in Thailand',
    'attr.activities':       'activities',
    'attr.whyBook':          'Why book with Werest Travel?',
    'attr.exploreAll':       '🌍 Explore all experiences',
    'attr.back':             '← Back',
    'attr.allExp':           'All experiences',
    'attr.noActivities':     'No activities found',
    'attr.noActivitiesSub':  'Try a different search or destination',
    'attr.from':             'from',
    'attr.experiences':      'experiences',
    'attr.results':          'Results for',
    /* why book with us */
    'attr.why.instant.title': 'Instant confirmation',
    'attr.why.instant.desc':  'Get your voucher immediately after booking.',
    'attr.why.mobile.title':  'Mobile vouchers',
    'attr.why.mobile.desc':   'Show your phone at the entrance — no printing.',
    'attr.why.secure.title':  'Secure & trusted',
    'attr.why.secure.desc':   'SSL-encrypted payments. Trusted by 10,000+ travellers.',
  },
  ...
  TH: {
    ...
    /* hero service titles */
    'hero.transfer.title1': 'การเดินทางไทยของคุณ',
    'hero.transfer.title2': 'เริ่มต้นที่นี่',
    'hero.tours.title':       'ทัวร์และประสบการณ์ในประเทศไทย',
    'hero.attractions.title': 'ตั๋วสถานที่ท่องเที่ยวยอดนิยม',
    ...
    /* service tabs */
    'svc.transfer':    'รถรับส่งส่วนตัว',
    'svc.tours':       'ทัวร์และประสบการณ์',
    ...
    'svc.charter':      'เช่าเหมาคัน',
    /* SEO route tabs */
    'seo.tab.popular':   'เส้นทางยอดนิยม',
    'seo.tab.airport':   'รถรับส่งสนามบิน',
    'seo.tab.city':      'เมืองต่อเมือง',
    'seo.tab.beach':     'ปลายทางชายหาด',
    'seo.tab.northern':  'ภาคเหนือของไทย',
    /* home sections */
    'home.newUser':      'สิทธิพิเศษสำหรับผู้ใช้ใหม่',
    'home.whereNext':    'จะไปที่ไหนต่อ?',
    'home.vehicleOpts':  'ตัวเลือกรถ',
    'home.upTo':         'สูงสุด',
    'home.passengers':   'ผู้โดยสาร',
    /* dynamic tour sections */
    'tours.thingsToDo':      'สิ่งที่น่าทำใน',
    'tours.handpicked':      'ประสบการณ์ที่คัดสรร — จองได้เลย',
    'tours.seeAll':          'ดูทั้งหมด',
    'tours.availableNow':    'พร้อมให้บริการ',
    'tours.reviews':         'รีวิว',
    'tours.comingSoon':      'เร็วๆ นี้ที่',
    'tours.comingSoonDesc1': 'เรากำลังคัดสรรประสบการณ์ที่ดีที่สุดใน',
    'tours.comingSoonDesc2': 'ในระหว่างนี้ ลองดูทัวร์กรุงเทพฯ ของเรา',
    'tours.browseAll':       'ดูประสบการณ์ทั้งหมด',
    /* navbar mobile strings */
    'nav.searchBookings':    'ค้นหาการจอง',
    'nav.signInRegister':    'เข้าสู่ระบบ/ลงทะเบียน',
    'nav.myAccount':         'บัญชีของฉัน',
    'nav.myBookings':        'การจองของฉัน',
    'nav.accessSavings':     'เข้าถึงส่วนลดพิเศษ — เพียงขั้นตอนเดียว!',
    'nav.savingsPerks1':     '💰 ส่วนลดสุดพิเศษ',
    'nav.savingsPerks2':     '⭐ รางวัลจากการจอง',
    'nav.settings':          'การตั้งค่า',
    'nav.travelOptions':     'ตัวเลือกการเดินทาง',
    'nav.more':              'เพิ่มเติม',
    'nav.dealsRewards':      'ดีลและรางวัล',
    'nav.helpCenter':        'ศูนย์ช่วยเหลือ',
    'nav.contactUs':         'ติดต่อเรา',
    'nav.manageBookings':    'จัดการการจอง',
    'nav.downloadApp':       'ดาวน์โหลดแอป',
    'nav.signOut':           'ออกจากระบบ',
    'nav.whereTo':           'จะไปไหน?',
    /* nav links */
    'nav.transfers':         'รถรับส่ง',
    'nav.thingsToDo':        'สิ่งที่น่าทำ',
    /* attractions page */
    'attr.hero.title':       'ค้นพบสวนสนุก พิพิธภัณฑ์ และสถานที่ท่องเที่ยวที่ดีที่สุด',
    'attr.hero.sub':         'จองตั๋วข้ามคิว ทัวร์ และประสบการณ์ทั่วประเทศไทย',
    'attr.searchPlaceholder':'ค้นหาสถานที่ท่องเที่ยว ปลายทาง…',
    'attr.breadcrumb':       'ตั๋วสถานที่ท่องเที่ยว',
    'attr.seeAll':           'ดูทั้งหมด',
    'attr.promos':           'โค้ดส่วนลด',
    'attr.promos.viewAll':   'ดูทั้งหมด',
    'attr.popularDests':     'ปลายทางยอดนิยมในประเทศไทย',
    'attr.activities':       'กิจกรรม',
    'attr.whyBook':          'ทำไมต้องจองกับ Werest Travel?',
    'attr.exploreAll':       '🌍 ดูประสบการณ์ทั้งหมด',
    'attr.back':             '← กลับ',
    'attr.allExp':           'ประสบการณ์ทั้งหมด',
    'attr.noActivities':     'ไม่พบกิจกรรม',
    'attr.noActivitiesSub':  'ลองค้นหาอื่นหรือเปลี่ยนปลายทาง',
    'attr.from':             'เริ่มต้นที่',
    'attr.experiences':      'ประสบการณ์',
    'attr.results':          'ผลลัพธ์สำหรับ',
    /* why book with us */
    'attr.why.instant.title': 'ยืนยันทันที',
    'attr.why.instant.desc':  'รับบัตรกำนัลทันทีหลังการจอง',
    'attr.why.mobile.title':  'บัตรกำนัลบนมือถือ',
    'attr.why.mobile.desc':   'แสดงโทรศัพท์ที่ทางเข้า — ไม่ต้องพิมพ์',
    'attr.why.secure.title':  'ปลอดภัยและเชื่อถือได้',
    'attr.why.secure.desc':   'การชำระเงินเข้ารหัส SSL เชื่อถือโดยนักท่องเที่ยวกว่า 10,000 คน',
  },
  ...
  ZH: {
    ...
    /* hero service titles */
    'hero.transfer.title1': '您的泰国之旅',
    'hero.transfer.title2': '从这里开始',
    'hero.tours.title':       '泰国旅游与体验',
    'hero.attractions.title': '顶级景点门票',
    ...
    'svc.charter':      '包车',
    /* SEO route tabs */
    'seo.tab.popular':   '热门路线',
    'seo.tab.airport':   '机场接送',
    'seo.tab.city':      '城市间',
    'seo.tab.beach':     '海滩目的地',
    'seo.tab.northern':  '泰国北部',
    /* home sections */
    'home.newUser':      '新用户专属',
    'home.whereNext':    '下一站去哪？',
    'home.vehicleOpts':  '车型选择',
    'home.upTo':         '最多',
    'home.passengers':   '位乘客',
    /* dynamic tour sections */
    'tours.thingsToDo':      '在这里可以做的事',
    'tours.handpicked':      '精选体验 — 即时预订',
    'tours.seeAll':          '查看全部',
    'tours.availableNow':    '现在可用',
    'tours.reviews':         '评价',
    'tours.comingSoon':      '即将推出',
    'tours.comingSoonDesc1': '我们正在为您精选最佳体验',
    'tours.comingSoonDesc2': '与此同时，探索我们的曼谷游览。',
    'tours.browseAll':       '浏览所有体验',
    /* navbar mobile strings */
    'nav.searchBookings':    '查询预订',
    'nav.signInRegister':    '登录/注册',
    'nav.myAccount':         '我的账户',
    'nav.myBookings':        '我的预订',
    'nav.accessSavings':     '一步解锁专属优惠！',
    'nav.savingsPerks1':     '💰 超值优惠',
    'nav.savingsPerks2':     '⭐ 预订返奖励',
    'nav.settings':          '设置',
    'nav.travelOptions':     '旅行选项',
    'nav.more':              '更多',
    'nav.dealsRewards':      '优惠与奖励',
    'nav.helpCenter':        '帮助中心',
    'nav.contactUs':         '联系我们',
    ...
    'nav.thingsToDo':        '活动体验',
    /* attractions page */
    'attr.hero.title':       '发现最佳主题公园、博物馆及更多必游景点',
    'attr.hero.sub':         '预订免排队门票、旅游和全泰国体验活动',
    'attr.searchPlaceholder':'搜索景点、目的地…',
    'attr.breadcrumb':       '景点门票',
    'attr.seeAll':           '查看全部',
    'attr.promos':           '优惠码',
    'attr.promos.viewAll':   '查看全部',
    'attr.popularDests':     '泰国热门目的地',
    'attr.activities':       '项活动',
    'attr.whyBook':          '为何选择Werest Travel预订？',
    'attr.exploreAll':       '🌍 浏览所有体验',
    'attr.back':             '← 返回',
    'attr.allExp':           '所有体验',
    'attr.noActivities':     '未找到活动',
    'attr.noActivitiesSub':  '请尝试不同的搜索词或目的地',
    'attr.from':             '起价',
    'attr.experiences':      '体验',
    'attr.results':          '搜索结果：',
    /* why book with us */
    'attr.why.instant.title': '即时确认',
    'attr.why.instant.desc':  '预订后立即收到凭证',
    'attr.why.mobile.title':  '手机凭证',
    'attr.why.mobile.desc':   '在入口出示手机即可 — 无需打印',
    'attr.why.secure.title':  '安全可信赖',
    'attr.why.secure.desc':   'SSL加密支付，深受10,000+旅行者信赖',
  },
};
