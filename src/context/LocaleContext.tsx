...
const T: Record<Lang, Strings> = {
  ...
  EN: {
    ...
    /* hero service titles */
    'hero.transfer.title1': 'Hey there, Your Thailand Journey',
    ...
    /* trust bar */
    'trust.bar.cancel':   'Cancel for free 24 hours before departure',
    'trust.bar.reviews':  '320+ reviews',
    'trust.bar.excellent':'Excellent',
    'trust.bar.tp.reviews': '95+ reviews',
    /* search dropdown */
    'search.history':     'Search history',
    'search.othersTravelled': 'Other travelers searched for',
    'search.topSearches': 'Top searches',
    'search.trending':    'Trending destinations',
    /* private ride form */
    'form.fromPlaceholder':   'From city, hotel, airport',
    'form.toPlaceholder':     'To city, hotel, airport',
    'form.addReturn':         'Add return',
    ...
    /* hourly form */
    'hourly.pickupLocation':  'Pickup location',
    'hourly.hotelAirport':    'Hotel, airport, address…',
    'hourly.dateTime':        'Date & time',
    'hourly.selectDate':      'Select date',
    'hourly.duration':        'Duration',
    'hourly.passengers':      'Passengers',
    'hourly.pickupDate':      'Pick-up date',
    /* search tabs */
    'tab.privateTransfers':   'Private Transfers',
    'tab.toursExp':           'Tours & Experiences',
    'tab.attractionsTicket':  'Attractions ticket',
    'tab.sub.transfers':      'Transfers',
    'tab.sub.hourly':         'Hourly',
    /* attractions section labels */
    'attr.sec.unmissable':    'Unmissable experiences',
    'attr.sec.cultural':      'Culture & history',
    'attr.sec.fun':           'Fun & entertainment',
    'attr.sec.shows':         'Events & shows',
    'attr.fromPrice':         'from',
    /* inspired dests */
    'dest.explore':           'Explore →',
    /* new user cards */
    'newUser.title':          'New users get more discounts on travel!',
    'newUser.sub':            'Sign in to unlock exclusive welcome deals',
    'newUser.cta':            'Sign in & claim all',
    'newUser.off10.title':    '10% off',
    'newUser.off10.sub':      'First Transfer',
    'newUser.cancel.title':   'Free cancel',
    'newUser.cancel.sub':     'Up to 24h before pickup',
    'newUser.off15.title':    '15% off',
    'newUser.off15.sub':      'Airport Transfers',
    'newUser.claimAll':       'Claim all',
    /* tours page */
    'tours.page.title':       'Attractions & Tours',
    'tours.page.subtitle':    'Discover places and things to do',
    'tours.page.unmissable':  'Unmissable experiences',
    'tours.page.noFound':     'No experiences found',
    'tours.page.browseAll':   'Browse all experiences',
    'tours.page.exploreAll':  'Explore all experiences',
    'tours.page.promoCodes':  'Promo codes',
    'tours.page.promoRedeem': 'Redeem and save on bookings',
    'tours.page.viewAll':     'View all',
    'tours.page.byDest':      'Browse by destination',
    'tours.page.noFoundTitle':'No experiences found',
    'tours.page.freeCancellation': 'Free cancel',
    /* footer */
    'footer.company':         'Company',
    'footer.services':        'Services',
    'footer.support':         'Support',
    'footer.cheaperOnApp':    'Cheaper on the app',
    'footer.appDeals':        'Exclusive mobile deals & instant updates',
    'footer.secureTransaction': 'Secure your transaction',
    'footer.trustedBy':       'Trusted by',
    'footer.followUs':        'Follow us',
    'footer.copyright':       '© {year} Werest Travel Co., Ltd. All rights reserved.',
    'footer.operatedBy':      'Operated by',
    /* footer links */
    'footer.aboutWerest':     'About Werest',
    'footer.travelBlog':      'Travel Blog',
    'footer.careers':         'Careers',
    'footer.corporateTravel': 'Corporate Travel',
    'footer.partnerProgram':  'Partner Program',
    'footer.hostAgencies':    'Host Agencies',
    'footer.becomePartner':   'Become a Partner',
    'footer.privateTransfers':'Private Transfers',
    'footer.airportTransfers':'Airport Transfers',
    'footer.toursExp':        'Tours & Experiences',
    'footer.groupBooking':    'Group Booking',
    'footer.dealsOffers':     'Deals & Offers',
    'footer.giftVouchers':    'Gift Vouchers',
    'footer.charter':         'Charter',
    'footer.helpCenter':      'Help Center',
    'footer.contactUs':       'Contact Us',
    'footer.customerSupport': 'Customer Support',
    'footer.trackBooking':    'Track My Booking',
  ...
  TH: {
    ...
    /* trust bar */
    'trust.bar.cancel':   'ยกเลิกฟรีภายใน 24 ชั่วโมงก่อนออกเดินทาง',
    'trust.bar.reviews':  '320+ รีวิว',
    'trust.bar.excellent':'ยอดเยี่ยม',
    'trust.bar.tp.reviews': '95+ รีวิว',
    /* search dropdown */
    'search.history':     'ประวัติการค้นหา',
    'search.othersTravelled': 'นักท่องเที่ยวคนอื่นค้นหา',
    'search.topSearches': 'ค้นหายอดนิยม',
    'search.trending':    'ปลายทางที่กำลังมาแรง',
    /* private ride form */
    'form.fromPlaceholder':   'จาก เมือง โรงแรม สนามบิน',
    'form.toPlaceholder':     'ถึง เมือง โรงแรม สนามบิน',
    'form.addReturn':         'เพิ่มขาเดินทางกลับ',
    'form.multiCity':         'หลายเมือง',
    'form.roundTripLabel':    'ไป-กลับ',
    'form.paxSummary':        'ผู้โดยสาร',
    'form.extraBags':         'กระเป๋าเพิ่มเติม',
    'form.errPickup':         'กรุณากรอกจุดรับ',
    'form.errDropoff':        'กรุณากรอกจุดส่ง',
    /* hourly form */
    'hourly.pickupLocation':  'สถานที่รับ',
    'hourly.hotelAirport':    'โรงแรม สนามบิน ที่อยู่...',
    'hourly.dateTime':        'วันที่และเวลา',
    'hourly.selectDate':      'เลือกวันที่',
    'hourly.duration':        'ระยะเวลา',
    'hourly.passengers':      'ผู้โดยสาร',
    'hourly.pickupDate':      'วันที่รับ',
    /* search tabs */
    'tab.privateTransfers':   'รถรับส่งส่วนตัว',
    'tab.toursExp':           'ทัวร์และประสบการณ์',
    'tab.attractionsTicket':  'ตั๋วสถานที่ท่องเที่ยว',
    'tab.sub.transfers':      'รถรับส่ง',
    'tab.sub.hourly':         'รายชั่วโมง',
    /* attractions section labels */
    'attr.sec.unmissable':    'ประสบการณ์ที่ต้องไม่พลาด',
    'attr.sec.cultural':      'วัฒนธรรมและประวัติศาสตร์',
    'attr.sec.fun':           'ความสนุกและความบันเทิง',
    'attr.sec.shows':         'กิจกรรมและการแสดง',
    'attr.fromPrice':         'เริ่มต้น',
    /* inspired dests */
    'dest.explore':           'สำรวจ →',
    /* new user cards */
    'newUser.title':          'ผู้ใช้ใหม่รับส่วนลดพิเศษมากกว่า!',
    'newUser.sub':            'เข้าสู่ระบบเพื่อรับดีลต้อนรับสุดพิเศษ',
    'newUser.cta':            'เข้าสู่ระบบและรับทั้งหมด',
    'newUser.off10.title':    'ลด 10%',
    'newUser.off10.sub':      'การจองครั้งแรก',
    'newUser.cancel.title':   'ยกเลิกฟรี',
    'newUser.cancel.sub':     'ก่อน 24 ชั่วโมงก่อนรับ',
    'newUser.off15.title':    'ลด 15%',
    'newUser.off15.sub':      'รถรับส่งสนามบิน',
    'newUser.claimAll':       'รับทั้งหมด',
    /* tours page */
    'tours.page.title':       'สถานที่ท่องเที่ยวและทัวร์',
    'tours.page.subtitle':    'ค้นพบสถานที่และสิ่งที่น่าทำ',
    'tours.page.unmissable':  'ประสบการณ์ที่ต้องไม่พลาด',
    'tours.page.noFound':     'ไม่พบประสบการณ์',
    'tours.page.browseAll':   'ดูประสบการณ์ทั้งหมด',
    'tours.page.exploreAll':  'สำรวจประสบการณ์ทั้งหมด',
    'tours.page.promoCodes':  'โค้ดส่วนลด',
    'tours.page.promoRedeem': 'แลกรับและประหยัดค่าจอง',
    'tours.page.viewAll':     'ดูทั้งหมด',
    'tours.page.byDest':      'เลือกตามปลายทาง',
    'tours.page.noFoundTitle':'ไม่พบประสบการณ์',
    'tours.page.freeCancellation': 'ยกเลิกฟรี',
    /* footer */
    'footer.company':         'บริษัท',
    'footer.services':        'บริการ',
    'footer.support':         'บริการลูกค้า',
    'footer.cheaperOnApp':    'ราคาถูกกว่าในแอป',
    'footer.appDeals':        'ดีลเฉพาะมือถือและอัปเดตทันที',
    'footer.secureTransaction': 'ชำระเงินอย่างปลอดภัย',
    'footer.trustedBy':       'ได้รับความไว้วางใจจาก',
    'footer.followUs':        'ติดตามเรา',
    'footer.copyright':       '© {year} Werest Travel Co., Ltd. สงวนลิขสิทธิ์',
    'footer.operatedBy':      'ดำเนินการโดย',
    /* footer links */
    'footer.aboutWerest':     'เกี่ยวกับ Werest',
    'footer.travelBlog':      'บล็อกท่องเที่ยว',
    'footer.careers':         'ร่วมงานกับเรา',
    'footer.corporateTravel': 'บริการองค์กร',
    'footer.partnerProgram':  'โปรแกรมพาร์ทเนอร์',
    'footer.hostAgencies':    'เอเจนซีท่องเที่ยว',
    'footer.becomePartner':   'เป็นพาร์ทเนอร์กับเรา',
    'footer.privateTransfers':'รถรับส่งส่วนตัว',
    'footer.airportTransfers':'รถรับส่งสนามบิน',
    'footer.toursExp':        'ทัวร์และประสบการณ์',
    'footer.groupBooking':    'จองกลุ่ม',
    'footer.dealsOffers':     'ดีลและข้อเสนอ',
    'footer.giftVouchers':    'บัตรกำนัล',
    'footer.charter':         'เช่าเหมาคัน',
    'footer.helpCenter':      'ศูนย์ช่วยเหลือ',
    'footer.contactUs':       'ติดต่อเรา',
    'footer.customerSupport': 'บริการลูกค้า',
    'footer.trackBooking':    'ติดตามการจอง',
    'footer.cancellationPolicy': 'นโยบายการยกเลิก',
    'footer.termsOfService':  'เงื่อนไขการใช้บริการ',
  ...
  ZH: {
    ...
    /* trust bar */
    'trust.bar.cancel':   '出发前24小时免费取消',
    'trust.bar.reviews':  '320+条评价',
    'trust.bar.excellent':'优秀',
    'trust.bar.tp.reviews': '95+条评价',
    /* search dropdown */
    'search.history':     '搜索历史',
    'search.othersTravelled': '其他旅行者的搜索',
    'search.topSearches': '热门搜索',
    'search.trending':    '热门目的地',
    /* private ride form */
    'form.fromPlaceholder':   '出发城市、酒店、机场',
    'form.toPlaceholder':     '目的城市、酒店、机场',
    'form.addReturn':         '添加返程',
    'form.multiCity':         '多城市',
    'form.roundTripLabel':    '往返',
    'form.paxSummary':        '位乘客',
    'form.extraBags':         '件额外行李',
    'form.errPickup':         '请输入接车地点',
    'form.errDropoff':        '请输入送达地点',
    /* hourly form */
    'hourly.pickupLocation':  '接车地点',
    'hourly.hotelAirport':    '酒店、机场、地址…',
    'hourly.dateTime':        '日期和时间',
    'hourly.selectDate':      '选择日期',
    'hourly.duration':        '时长',
    'hourly.passengers':      '乘客',
    'hourly.pickupDate':      '接车日期',
    /* search tabs */
    'tab.privateTransfers':   '私人接送',
    'tab.toursExp':           '旅游与体验',
    'tab.attractionsTicket':  '景点门票',
    'tab.sub.transfers':      '接送',
    'tab.sub.hourly':         '按小时',
    /* attractions section labels */
    'attr.sec.unmissable':    '不可错过的体验',
    'attr.sec.cultural':      '文化与历史',
    'attr.sec.fun':           '娱乐与欢乐',
    'attr.sec.shows':         '活动与表演',
    'attr.fromPrice':         '起价',
    /* inspired dests */
    'dest.explore':           '探索 →',
    /* new user cards */
    'newUser.title':          '新用户享受更多旅行折扣！',
    'newUser.sub':            '登录以解锁专属欢迎优惠',
    'newUser.cta':            '登录并领取全部',
    'newUser.off10.title':    '9折优惠',
    'newUser.off10.sub':      '首次预订',
    'newUser.cancel.title':   '免费取消',
    'newUser.cancel.sub':     '接车前24小时内',
    'newUser.off15.title':    '85折优惠',
    'newUser.off15.sub':      '机场接送',
    'newUser.claimAll':       '领取全部',
    /* tours page */
    'tours.page.title':       '景点与旅游',
    'tours.page.subtitle':    '发现景点和活动',
    'tours.page.unmissable':  '不可错过的体验',
    'tours.page.noFound':     '未找到体验活动',
    'tours.page.browseAll':   '浏览所有体验',
    'tours.page.exploreAll':  '探索所有体验',
    'tours.page.promoCodes':  '优惠码',
    'tours.page.promoRedeem': '兑换优惠码节省预订费用',
    'tours.page.viewAll':     '查看全部',
    'tours.page.byDest':      '按目的地浏览',
    'tours.page.noFoundTitle':'未找到体验活动',
    'tours.page.freeCancellation': '免费取消',
    /* footer */
    'footer.company':         '公司',
    'footer.services':        '服务',
    'footer.support':         '客户支持',
    'footer.cheaperOnApp':    '在应用内更便宜',
    'footer.appDeals':        '独家手机优惠及即时更新',
    'footer.secureTransaction': '安全支付',
    'footer.trustedBy':       '受信赖',
    'footer.followUs':        '关注我们',
    'footer.copyright':       '© {year} Werest Travel Co., Ltd. 版权所有',
    'footer.operatedBy':      '运营方',
    /* footer links */
    'footer.aboutWerest':     '关于Werest',
    'footer.travelBlog':      '旅游博客',
    'footer.careers':         '招聘',
    'footer.corporateTravel': '商务旅行',
    'footer.partnerProgram':  '合作伙伴计划',
    'footer.hostAgencies':    '旅行社',
    'footer.becomePartner':   '成为合作伙伴',
    'footer.privateTransfers':'私人接送',
    'footer.airportTransfers':'机场接送',
    'footer.toursExp':        '旅游与体验',
    'footer.groupBooking':    '团体预订',
    'footer.dealsOffers':     '优惠活动',
    'footer.giftVouchers':    '礼品券',
    'footer.charter':         '包车',
    'footer.helpCenter':      '帮助中心',
    'footer.contactUs':       '联系我们',
    'footer.customerSupport': '客户服务',
    'footer.trackBooking':    '追踪我的预订',
