  ...
  return (
    <div
      className={[
        ...
        '[&_figure_img]:rounded-2xl [&_figure_img]:w-full [&_figure_img]:object-cover [&_figure_img]:shadow-sm [&_figure_img]:mb-0',
        '[&_figcaption]:text-center [&_figcaption]:text-sm [&_figcaption]:text-gray-400 [&_figcaption]:italic [&_figcaption]:mt-2.5 [&_figcaption]:px-4',
