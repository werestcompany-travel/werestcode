          ...
          {step === 'landing' && (
            <>
              ...
              <button type="button" onClick={handleGoogle}
                className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50 hover:bg-gray-100 transition-colors mb-3 text-sm font-semibold text-gray-800">
              ...
              <button type="button" onClick={() => setStep('email')}
                className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl border-2 border-gray-900 bg-white hover:bg-gray-50 transition-colors mb-3 text-sm font-semibold text-gray-900">
              ...
              <button type="button" onClick={handleApple}
                className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl bg-black hover:bg-gray-900 transition-colors mb-6 text-sm font-semibold text-white">
