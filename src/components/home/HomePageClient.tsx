  ...
  return (
    <Fragment>
      ...
      <section aria-label="Hero" className="-mt-16 lg:-mt-24 mb-0 lg:mb-[30px]">
        ...
        {/* ── Hero card ── */}
        <div className="flex flex-col items-center justify-start lg:justify-center relative lg:min-h-[680px]" style={{ minHeight: '395px' }}>
          ...
          <div id="hero-search-anchor" className="relative z-10 w-full max-w-7xl mx-auto px-4 lg:px-6 pt-[120px] pb-[140px] lg:pt-[141px] lg:pb-12 flex flex-col items-center gap-3 lg:gap-5 text-center self-start lg:self-center">

            {/* Title */}
            <h1 className="text-[32px] leading-snug lg:text-[34px] font-extrabold text-white tracking-tight">
              {activeService === 'transfer'    && <span className="block mt-[10px]"><span className="font-medium">Hey there,</span> Your Thailand Journey {t('hero.transfer.title2')}</span>}
            ...
            <p className="mt-2 text-sm text-white font-medium tracking-wide">
        ...
        <div className="lg:hidden fixed inset-0 z-[9999] flex items-center justify-center px-4">
          ...
          <div className="relative bg-white w-full max-w-sm rounded-3xl shadow-2xl px-5 pt-6 pb-8 z-10">
            ...
            <div className="flex items-center justify-center mb-4">
              <Image src="/images/logo.png" alt="Werest" width={115} height={41} className="object-contain" unoptimized />
            </div>
