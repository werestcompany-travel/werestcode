    ...
    <Fragment>
      ...
      <section aria-label="Hero" className="-mt-16 mb-0 lg:mb-[30px]">
        ...
        <div className="flex flex-col items-center justify-start lg:justify-center overflow-hidden relative lg:min-h-[680px]" style={{ minHeight: '260px' }}>
          ...
          <div id="hero-search-anchor" className="relative z-10 w-full max-w-7xl mx-auto px-4 lg:px-6 pt-20 pb-2 lg:pt-[131px] lg:pb-12 flex flex-col items-center gap-3 lg:gap-5 text-center self-start lg:self-center">
