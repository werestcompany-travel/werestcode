 ...
 */
const WHATSAPP_NUMBER = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? '66621871392';

const WHATSAPP_MESSAGES: Record<string, string> = {
  EN: 'Hi Werest Travel! I would like to book a transfer.',
  TH: 'สวัสดีครับ/ค่ะ Werest Travel! ต้องการจองรถรับส่ง',
  ZH: '您好 Werest Travel！我想预订接送服务。',
};

/* WhatsApp SVG icon — matches official brand green */
  ...
  return (
    <a
      ...
      className={[
        ...
        'shadow-[0_4px_20px_rgba(37,211,102,0.50)]',
        'hover:shadow-[0_6px_28px_rgba(37,211,102,0.60)]',
    ...
    >
      ...
      <span className="hidden sm:inline whitespace-nowrap">{t('wa.label')}</span>
    </a>
  );
}
