...
export default function DestinationHeroOverlay({ cityName, description, descriptionFull }: Props) {
  ...
  return (
    <>
      {/* ── Text overlay pinned to bottom-left of hero ── */}
      <div className="absolute bottom-0 left-0 right-0 px-4 sm:px-5 pb-4 sm:pb-5 z-10">
        <h1 className="text-[22px] sm:text-3xl font-extrabold text-white leading-snug mb-1.5
      ...
      {/* ── Modal portaled to document.body — escapes any stacking context ── */}
